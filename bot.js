...
bot.onText(/\/start/, async msg => {
	...
	session[chatId] = states.waitingForName
})
	...
	switch (session[chatId]) {
		case states.waitingForName:
			try {
				...
				session[chatId] = states.waitingForWeek
				session['teacher'] = teacher
				session['link'] = teacher['Ссылка']
		...
		case states.waitingForWeek:
			...
			session[chatId] = states.waitingForDay
			break
		default:
